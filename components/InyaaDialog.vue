              ...
              <span class="px-2 bg-white text-gray-500">
                第三方登陆
                          ...
                          <div class="mt-6 grid grid-cols-3 gap-3">
                            <div>
                              <a href="#" @click="qqLogin" class="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50">
                            ...
                            <div>
                              <a href="#" @click="githubLogin" class="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50">
